...
/*   Updated: 2024/05/21 16:20:23 by evan-ite         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	distance_kim(t_game *g)
{
	...
	distx = g->player->coord.x - g->sm.sp_coor[g->sm.order[g->map->n_kim - 1]].x;
	disty = g->player->coord.y - g->sm.sp_coor[g->sm.order[g->map->n_kim - 1]].y;
